const messages = {
  "EN": {
    "message": {
      ...
      "phone_can_login": "Mobile phone number can be used as login account",
      "order": "ORDER",
      ...
      "check_fields": "Please complete the registration information and verification code",
      "Go": "Go",
      "Mon": "Mo.",
      ...
      "Please_i": "For this service, do you have additional requirements for engineers in foreign language ability, server capacity, programming network /PBX equipment, if yes, please list, and at the same time for the additional requirements of the service, we will also increase the price, please forgive us!",
      "Back": "Back",
      "Sure_delete": "Delete?",
      "Ok": "Ok",
      ...
      "Requestor": "Requestor",
      "Male": "Male",
      "pay_count": "Recharge amount (yuan)",
      ...
      "invoice_date": "Date of making an invoice",
      "yuyueshijian": "Time of appointment",
      "Sign": "sign",
      "FwonePay": "FwonePay",
      "Name": "Name",
      "service": "SERVICE",
      ...
      "Message": "Message",
      "Publish": "Publish",
      "password_error": "The password at least 6",
      "engineer_need": "Engineer Requirements",
      ...
      "use_it_before": "Please use it before {msg}",
      "Cancel": "Cancel",
      ...
      "name_password_empty": "User name and password can not be empty",
      ...
      "record": "record",
      "Language": "Language",
      "progressing": "In acceptance",
      "baojia": "offer",
      "Order_status": "Order status",
      "Female": "Female",
      "Service_detail": "Service detail",
      "join_company": "Join enterprise",
      ...
      "phone_error": "Cell phone number format error",
      ...
      "phone_used": "The number has been used",
      "Please_describe_oncall": "Please briefly describe the issue, the time and the frequency of its occurrence. This will assist our engineers to identify the issue.",
      ...
      "Resend": "resend",
      "Duration": "Duration",
      "InvitationCode": "Enterprise invitation code",
      "Offer_rmb": "Offer {msg} rmb",
      ...
      "Postion": "Postion",
      "anorder": "order",
      "history_select": "You have a history billing record, click select",
      ...
      "Fri": "Fr.",
      "mark_error": "English abbreviation only supports English letters",
      ...
      "email_used": "The mailbox has been used",
      "Payment": "Payment",
      "Overall": "Overall",
      ...
      "Not_superimposed_use": "Not superimposed",
      "Please_describe_ma": "Please briefly describe the issue, the time and the frequency of its occurrence. This will assist our engineers to identify the issue.",
      ...
      "Cancelled": "Cancelled",
      "Server_need": "Service requirement",
      "remark": "Remarks",
      "reset_pwd": "重置密码",
      "Satisfied": "satisfied",
      ...
      "Del_success": "Success",
      "company_id_error": "The business license number format is incorrect",
      "user": "USER",
      ...
      "Links_expire": "Links expire",
      "Resend_message": "Resend a message",
      "Verification_code_error": "Verification code error or expiration",
      "Registration_mobile": "Registration of mobile phone"
    }
  },
  "CN": {
    "message": {
      ...
      "Disable": "已使用/已过期",
      "All_orders": "全部工单",
      "Please_i": "请填写工程师能力的要求（如：英文沟通、CCNA、MCSE、OCP等） 注-本项为非必填项，服务台会对您的要求进行评估并增加相应的费用",
      "Back": "返回",
      "Sure_delete": "确定删除？",
      "Ok": "确定",
      ...
      "name_password_empty": "用户名和密码不能为空",
      "My_complains": "我的投诉",
      "click": "点击获取",
      "Result": "处理结果",
      "Wrong_captcha": "验证码错误",
      ...
      "phone_used": "号码已被使用",
      "Please_describe_oncall": "请填写具体故障现象，发生故障时间，故障出现频率等详细信息有利于工程师更快地定位问题",
      ...
      "Not_superimposed_use": "不可叠加",
      "Please_describe_ma": "请填写工程师在现场的服务要求",
      "Received_by": "受理人",
      "Success": "成功",
      "Call_reminder": "我的催单",
      "Gender": "性别",
      ...
      "Recharge": "充值",
      "use_coupon": "使用优惠券",
      "Links_expire": "连接过期或失效",
      "Resend_message": "重新发送邮件",
      "Verification_code_error": "验证码错误或过期",
      "Registration_mobile": "手机号注册"
    }
  },
  "TN": {
    "message": {
      ...
      "Detail": "詳情",
      "Report_time": "報修時間",
      "phone_can_login": "手機號可作為登入帳號",
      "order": "訂單",
      "Fault_description": "故障描述",
      "forget_password": "忘記密碼",
      "Range_time": "時間範圍",
      "Service_definition": "服務定義",
      "Price_curve": "價格曲線",
      "complaint": "投訴",
      "Rate_placeholder": "服务周到吗？（写够15字才是好同志）",
      "No_more_data": "沒有更多數據",
      "Cost_Estimation": "計算價格",
      "check_fields": "請填寫完整的注册資訊及驗證碼",
      "Go": "前往",
      "Mon": "週一",
      "Notifications": "通知",
      "Publish_tip": "加油！還差{Num}字就可以發佈了。",
      "New_service_address": "新增服務點",
      "Network_disconnect": "網絡斷開連接…",
      "Other": "其他",
      "Switchable_account": "可切換帳號",
      "Cause_complaint": "投訴主體",
      "Already_exists": "已存在",
      "My_coupons": "我的優惠券",
      "Street": "街道",
      "Modes_of_Payment": "支付方式",
      "Report_by_me": "顯示我的報修",
      "No_switch_account": "無可切換帳號",
      "Engineer_issues": "工程師解决能力低",
      "Required_fields": "必填項",
      "Not_satisfied": "一般",
      "Mark_help": "標識即為公司英文簡稱",
      "Leave": "離開",
      "cell-phone_help": "綁定手機號可作為登入帳號",
      "please_enter": "請輸入",
      "Complaints": "投訴資訊",
      "Please_input": "請輸入",
      "Very_dissatisfied": "不滿意",
      "Company_id_num": "營業執照註冊號",
      "Confirm_price": "價格確認",
      "Coupon": "優惠券",
      "Self_evaluation": "自我評價",
      "To_rate": "待評估",
      "Before_Tomorrow": "明天前",
      "Collection_date": "收款日期",
      "qingshuru": "請輸入",
      ...
      "Disable": "已使用/已過期",
      "All_orders": "全部工單",
      "Please_i": "請填寫工程師能力的要求（如：英文溝通、CCNA、MCSE、OCP等） 注-本項為非必填項，服務台會對您的要求進行評估並增加相應的費用",
      "Back": "返回",
      "Sure_delete": "確定删除？",
      "Ok": "確定",
      "Include_weekend": "是否週末",
      "Last_year": "去年",
      ...
      "Male": "男",
      "pay_count": "充值金額（元）",
      "Response_not_timely": "響應不及時",
      "Incorrect_format": "格式不正確",
      "Service_level": "服務評估",
      "Msg_send": "簡訊已發出，請查收",
      "Accept": "接受",
      "Letter_only": "只支持字母",
      "Engineer_information": "工程師名片",
      "Processed": "已受理",
      "Start_date": "開始日期",
      "invoice_date": "開票日期",
      "yuyueshijian": "預約時間",
      ...
      "service": "預約",
      "End_time": "結束時間",
      "Timely_assistance": "及時雨",
      "Wed": "週三",
      "Message": "消息",
      "Publish": "發佈",
      "password_error": "密碼至少6比特",
      "engineer_need": "工程師要求",
      "Personal_information": "個人資訊",
      "Complaints_suggestions": "投訴與建議",
      "Company": "公司",
      "Subtotal": "小計",
      "User": "用戶",
      ...
      "Password": "密碼",
      "Very_satisfied": "非常滿意",
      "Validation_fails": "表單驗證失敗",
      "use_it_before": "請於{msg}前使用",
      "Cancel": "取消",
      "Working_day": "限工作日",
      "Last_months": "上月",
      "UnionPay": "銀聯支付",
      ...
      "UseItem": "點擊獲取",
      "Please_score": "請評估",
      "Company_id_num_help": "請輸入15比特營業執照號或18比特的統一社會信用程式碼",
      "name_password_empty": "用戶名和密碼不能為空",
      "My_complains": "我的投訴",
      "click": "點擊獲取",
      "Result": "處理結果",
      "Wrong_captcha": "驗證碼錯誤",
      "Rating": "評論",
      "Admin_id_num": "管理員身份證號",
      "Complete": "完成",
      "record": "記錄",
      "Language": "語言能力",
      "progressing": "受理中",
      ...
      "join_company": "加入企業",
      "Location_list": "服務點清單",
      "MA_des": "根據客戶定義上下班時間，無論是否有問題發生均在現場待命。",
      "In_service": "您本次的請求已包含在【包月/包年】服務中。如產生其他的費用，群思服務台會和您進行溝通，感謝您選擇群思，祝您工作愉快！",
      "Address": "服務點",
      "Save_successful": "保存成功",
      "phone_error": "手機號格式錯誤",
      "Processing": "處理中",
      "Start_time": "開始時間",
      "Oncall_des": "根據客戶期望的時間段，為客戶解决某問題，解决完畢後離開",
      "Confirm": "確定下單",
      "Reminder": "催單",
      "Unvalued": "未評估",
      "Save": "保存",
      ...
      "company_address": "公司地址",
      "phone_used": "號碼已被使用",
      "Please_describe_oncall": "請填寫具體故障現象，發生故障時間，故障出現頻率等詳細信息有利於工程師更快地定位問題，解決故障。",
      "Service_location": "服務點",
      "Bill-to_address": "收票地址",
      "Create_time": "創建時間",
      "repeat_password": "重複密碼",
      "Reply": "處理回復",
      "Send_email_des": "郵件已發送至{msg}，請及時查收並啟動",
      "Depart": "出發",
      "Resend": "重新發送",
      "Duration": "起止時間",
      "InvitationCode": "企業邀請碼",
      "Offer_rmb": "已為您優惠{msg}元",
      "Display_on_call": "顯示現場工單",
      "signup_email": "郵箱註冊",
      "Engineers_frequently": "工程師更換頻繁",
      "Check_password": "確認密碼",
      "Ordinary": "滿意",
      "Mark": "標識",
      "Invoice": "發票",
      ...
      "Postion": "崗位",
      "anorder": "下單",
      "history_select": "您有歷史開票記錄，點擊選擇",
      "Processing_result": "處理結果",
      "AdminName": "管理員姓名",
      "Without_the_invoice": "無需發票",
      "Overall_balance": "總餘額",
      "No_found": "暫無介紹…",
      "Completed": "已完成",
      "Can_time_list": "工程師可上門的時間清單",
      "Account_name": "帳號名",
      "Fri": "周五",
      "mark_error": "英文簡稱只支持英文字母",
      "Unprocessed": "待處理",
      "Choose_location": "請選擇服務點…",
      "Delayed": "已過期",
      "Please_describe": "請描述故障…",
      "Login": "登入",
      "Sun": "周日",
      "NO": "編號",
      "Lunch_break": "是否午休",
      ...
      "Payment": "付款",
      "Overall": "總  體",
      "Pull_to_refresh": "下拉重繪",
      "Engineer_Headcount": "工程師數量",
      "Last_6_months": "近6個月",
      "bank_of_deposit": "開戶銀行",
      "Complains_details": "投訴內容",
      "password": "密碼",
      "Complaint_wait": "您的投訴正在受理中…請稍等…",
      "Wrong_Verification": "驗證碼過期",
      "Not_superimposed_use": "不可疊加",
      "Please_describe_ma": "請填寫工程師在現場的服務要求",
      "Received_by": "受理人",
      "Success": "成功",
      "Call_reminder": "我的催單",
      "Gender": "性别",
      "invoice_information_incomplete": "發票資訊不全，請補充",
      "Paid": "已付款",
      "Range_date": "時間",
      "Cancelled": "已取消",
      "Server_need": "服務要求",
      ...
      "reset_pwd": "重置密码",
      "Satisfied": "滿意",
      "Company_name_help": "需與當地政府頒發的商業許可證或企業註冊證上的企業名稱完全一致",
      "Arrive": "到達",
      "Minimum_6": "至少6比特",
      "Solving_steps": "處理過程",
      "des": "群思科技，成立於2001年，為400多個跨國公司在亞洲的60多個都市提供專業科技工程師、IT基礎設施和Helpdesk外包服務。",
      "End_date": "結束日期",
      "Appointment_time": "上门时间",
      "Del_success": "删除成功",
      "company_id_error": "營業執照號格式不正確",
      "user": "我的",
      "Service_years": "服務年限",
      "title": "致力於成為世界級領先的專業IT服務企業用責任心、科技、流程和規範，使用戶任何時間、任何地點都能及時得到群思專業服務向顧客提供富有傳奇色彩的顧客服務、永不止境地投入到提升顧客滿意的努力中去",
      "By_today": "今天内",
      "Service_introduction": "服務介紹",
      "Tues": "週二",
      "Telephone": "電話協助",
      "Pay": "支付",
      "Area": "所在地區",
      ...
      "Sat": "週六",
      "Remote_desktop": "遠程連接",
      "Complaints_successfully": "投訴成功",
      "Detailed_address": "詳細地址",
      "Alipay": "支付寶",
      "Reset": "重置",
      "Email": "郵箱",
      "Attitude_issues": "工程師態度問題",
      "Entered_differ": "密碼不一致",
      "Expired": "已過期",
      "Last_3_months": "近3個月",
      "taxpayer_registration_number": "納稅人識別號",
      "Reset_success": "重置成功",
      "Phone_number": "手機號",
      "Complaints_department": "投訴部門",
      "Auth_code": "簡訊驗證碼",
      "Rating_processing_result": "請您對本次處理結果進行評估",
      "Admin_phone_num": "管理員手機號",
      "Regular_invoice": "普票",
      "Recharge": "充值",
      "use_coupon": "使用優惠券",
      "Links_expire": "连接过期或失效",
